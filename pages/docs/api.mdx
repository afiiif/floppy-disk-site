...
- **Methods**
  ...
  - `useQuery.reset` Reset query state for all query keys
  - `useQuery.resetSpecificKey` Reset a specific query state
  - `useQuery.invalidate` Invalidate query for all query keys
  ...
  - `useQuery.suspend` Use query with suspense mode
