...
- `options?` (_optional_)
  ...
  - `onBeforeFetch` Triggered before fetch/refetch, can also be used to cancel fetch
  - `onSuccess` Triggered after fetch/refetch succeed
  - `onError` Triggered after fetch/refetch failed
  - `onSettled` Triggered after fetch/refetch (both succeed or failed)
