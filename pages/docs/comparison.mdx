...
[floppy-disk-badge]: https://pkg-size.dev/badge/bundle/8831
...
|                                                                          |                                             Floppy Disk @2.3.0                                              |        Zustand @4.4.1         |    TanStack<br/>Query<br/>@4.33.0     |      SWR @2.2.2       |
| ------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------: | :---------------------------: | :-----------------------------------: | :-------------------: |
| Bundle size (https://pkg-size.dev)                                       | [![][floppy-disk-badge]][floppy-disk]<div className="whitespace-nowrap pt-1 text-xs">(gzipped 3.3 kB)</div> | [![][zustand-badge]][zustand] | [![][react-query-badge]][react-query] | [![][swr-badge]][swr] |
