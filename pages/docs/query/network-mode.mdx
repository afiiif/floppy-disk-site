...
Example: [https://codesandbox.io/.../examples/react/query-network-status](https://codesandbox.io/p/sandbox/github/afiiif/floppy-disk/tree/main/examples/react/query-network-status)
</Callout>
