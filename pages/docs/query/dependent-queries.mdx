...
Example: [https://codesandbox.io/.../examples/react/dependent-queries](https://codesandbox.io/p/sandbox/github/afiiif/floppy-disk/tree/main/examples/react/dependent-queries)
</Callout>
