...
<Link className="inline-block mt-5 btn-secondary" href="/blog/introducing-floppy-disk">Read Full Article →</Link>
...
import { createStore } from 'floppy-disk'; // 1.4 kB (gzipped: 724 B) 🎉
