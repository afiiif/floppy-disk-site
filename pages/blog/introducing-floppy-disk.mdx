...
keywords: React, State Management, Floppy Disk, Store, TanStack-Query, Zustand, Alternative
...
As I mentioned in the previously, finally I create a Zustand-like state manager, but with more features:
...
<div className="text-sm pt-12 opacity-80 hover:opacity-100">
Anyway, why is it called "Floppy Disk"?<br/>
I put a data in it, and it was a tiny store, then "Floppy Disk" comes to my mind.
Also, the nowadays generation seems to be unfamiliar with the real object of a "save icon" 😅, I think it will help them knowing its real name.
</div>
